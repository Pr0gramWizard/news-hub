			...
			<div className={classes.inner}>
				...
				<Container p={0} size={600}>
					<Text size="lg" color="dimmed" className={classes.description}>
						Development of a framework to access, collect, and study news shared on social media
					</Text>
				</Container>

				<div className={classes.controls}>
					<ButtonLink to="/" classes={classes.control} size="lg" variant="default" color="gray">
						Go to Dashboard
					</ButtonLink>
