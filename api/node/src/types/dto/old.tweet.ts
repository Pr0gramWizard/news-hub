...
export class LastIdQuery {
	@ApiProperty({ description: 'Lower bound for the id of the returned tweets', required: false, name: 'last_id' })
	lastId?: string;
}
...
export class OldTweetFrequencyResponse {
	@ApiProperty()
	labels!: number[];
